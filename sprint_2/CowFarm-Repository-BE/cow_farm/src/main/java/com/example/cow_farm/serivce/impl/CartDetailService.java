...
public class CartDetailService implements ICartDetailService {
    ...
    @Override
    public List<ICartDetailDto2> findAllvCartDetailByPurchaseHistory(Long purchaseHistory) {
        return  this.cartDetailRepository.findAllvCartDetailByPurchaseHistory(purchaseHistory);
    }
